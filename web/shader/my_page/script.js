...
async function setupTexture(gl, textureUnit, imageUrl)
{
...
async function main()
{
    ...
    const textures = [
        await setupTexture(gl, 0, 'texture0.png'),
        await setupTexture(gl, 1, 'texture1.png'),
        await setupTexture(gl, 2, 'texture2.png'),
        await setupTexture(gl, 3, 'texture3.png')
    ];
